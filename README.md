...
<!-- SUPPORTED_FORMATS_START -->
JPEG, PNG, TIFF, WebP, AVIF, HEIC (read), PDF, RAW (read: DNG, CR2/CR3, NEF, ARW, RAF, ORF, RW2, PEF, SRW, ほか — via LibRaw)
<!-- SUPPORTED_FORMATS_END -->

> The list above is auto-generated by [`scripts/sync-readme.sh`](scripts/sync-readme.sh) from [`libraries.json`](libraries.json). Do not edit it manually.
...
> Versions are managed in [`libraries.json`](libraries.json) and the table above is auto-generated by [`scripts/sync-readme.sh`](scripts/sync-readme.sh). Do not edit it manually.
...
```bash
# Replace vX.Y.Z-N with the release tag you want (see Releases page).
curl -fsSL https://raw.githubusercontent.com/jksy/imagemagick-build/main/install.sh | IMAGEMAGICK_VERSION=vX.Y.Z-N bash
```
...
export PKG_CONFIG_PATH="/opt/imagemagick/<version>/lib/pkgconfig:$PKG_CONFIG_PATH"
export LD_LIBRARY_PATH="/opt/imagemagick/<version>/lib:$LD_LIBRARY_PATH"
